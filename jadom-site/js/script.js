const plotImg150 = 'images/plot-150sqm.jpg';
  ...
  const JADOM_APPLICATIONS_EMAIL = 'Taiwoayomide101@gmail.com'; // <-- replace with your real Gmail address
  function appSubmit(){
    ...
    const body =
      ...
      'NEXT OF KIN\n' +
      'Full Name: ' + val('appKinName') + '\n' +
      'Relationship: ' + val('appKinRelationship') + '\n' +
      'Phone: ' + val('appKinPhone') + '\n' +
      'Email: ' + val('appKinEmail') + '\n' +
      'Address: ' + val('appKinAddress') + '\n\n' +
      'PROPERTY DETAIL\n' +
    ...
    const mailtoLink = 'mailto:' + JADOM_APPLICATIONS_EMAIL + '?subject=' + encodeURIComponent(subject) + '&body=' + encodeURIComponent(body);
